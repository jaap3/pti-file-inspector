import { drawWaveform } from './modules/visualize.js'
...
async function getSampleDataRow(file, markers, region, slices) {
  ...
  const audioCtxBuffer = audioCtx.createBuffer(1, bufferLength, 44100)
  ...
  drawWaveform(canvas, audioCtxBufferChannel, markers, region, slices)
